...
class AnnouncementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create announcement" do
    assert_difference('Announcement.count') do
      post announcements_url, params: { announcement: { ministry_id: @announcement.ministry_id, subject: @announcement.subject, text: @announcement.text, user_id: @announcement.user_id } }
    end
  ...
  test "should update announcement" do
    patch announcement_url(@announcement), params: { announcement: { ministry_id: @announcement.ministry_id, subject: @announcement.subject, text: @announcement.text, user_id: @announcement.user_id } }
