...
class MinistriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ministry" do
    assert_difference('Ministry.count') do
      post ministries_url, params: { ministry: { description: @ministry.description, name: @ministry.name } }
    end
  ...
  test "should update ministry" do
    patch ministry_url(@ministry), params: { ministry: { description: @ministry.description, name: @ministry.name } }
